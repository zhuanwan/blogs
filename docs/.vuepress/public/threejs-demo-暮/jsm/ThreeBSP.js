const THREEBSPFN = function(THREE) {
  ...
  ThreeBSP.prototype.toGeometry = function(groupByCoplanar, uniqueMaterial) {
    ...
    var geometry = new THREE.BufferGeometry(), matrix = new THREE.Matrix4().invert();
  ...
  ThreeBSP.Polygon = (function() {
    ...
    Polygon.prototype.tessellate = function(poly) {
      ...
      // 如果两个面是相交面，则进行插值处理
      var frontVertices = [], backVertices = [], count = poly.vertices.length, t, ti, tj, v, vi, vj, j;
