...
export function createBgPlane() {
  const geometry = new THREE.PlaneGeometry(700, 400) // 这里的值不知道怎么算的
  const material = new THREE.MeshBasicMaterial({
    color: 0x000825,
    opacity: 0.8,
    transparent: true,
...
// 管道2
export function createTube2() {
  const texture = createTubeTexture2()

  // 创建多段线条的顶点数据
  var p1 = new THREE.Vector3(-80, 0, 0)
  var p2 = new THREE.Vector3(0, 0, 0)
  var p3 = new THREE.Vector3(0, 40, 0)
  var p4 = new THREE.Vector3(80, 40, 0)
  let line1 = new THREE.LineCurve3(p1, p2)
  let line2 = new THREE.LineCurve3(p2, p3)
  let line3 = new THREE.LineCurve3(p3, p4)
  var curvePath = new THREE.CurvePath() // 创建CurvePath对象
  curvePath.curves.push(line1, line2, line3) // 插入多段线条
...
export function createSX() {
  ...
  meshF1.translateX(-26)
  meshF1.translateY(-50)

  const meshF2 = meshF1.clone()
  const meshF3 = meshF1.clone()
  const meshF4 = meshF1.clone()

  meshF1.rotateZ(50)
  meshF2.translateX(10)
  meshF2.rotateZ(50)
  meshF3.rotateZ(-50)
  meshF3.translateY(-10)
  meshF3.translateX(42)
  meshF4.rotateZ(-50)
  meshF4.translateY(-13)
  meshF4.translateX(52)

  // 组合
  var group = new THREE.Group()

  group.add(mesh1, meshFB, meshF1, meshF2, meshF3, meshF4)
  group.translateX(-50)
  group.translateY(-110)
  return group
}
